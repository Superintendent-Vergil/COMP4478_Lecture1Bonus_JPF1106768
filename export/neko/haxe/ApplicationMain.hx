...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Lecture 1 Bonus", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Lecture 1 Bonus", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Lecture 1 Bonus";
		app.meta["name"] = "Lecture 1 Bonus";
